...
def try_except_pass(func, *args, **kwargs):
    ...
    When wrapping a function we would ordinarily form a closure over a (sub)set of
    the inputs. Such closures cannot be pickled however since the wrapper name is not
...
def imap_mp(
    ...
    pass_exception=False, threads=1, unordered=False, chunksize=1, init=None, initargs=()
):
